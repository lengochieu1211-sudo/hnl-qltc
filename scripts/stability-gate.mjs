...
requireAll(desktopBuild, ['HNL-QLTC-HQ-256.png', 'Write-HnlIcoFromPng -PngPath $logoSource -IcoPath $generatedIcon', 'Certified multi-resolution ICO'], 'Windows certified HQ 256px artwork and multi-resolution icon generation');
