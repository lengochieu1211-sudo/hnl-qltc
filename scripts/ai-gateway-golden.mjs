...
try {
  // Public health is safe and identifies only the isolated DEV service.
  ...
  // Private endpoints require Firebase authentication.
  ...
  // A DEV preview channel origin is allowed without widening CORS to arbitrary web sites.
  ...
  // Provider/model/schema are closed whitelists.
  ...
  // A configured provider may be unavailable without causing a network fallback.
